    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
          <Link
            href="/"
            className="group flex items-center gap-2 text-lg font-bold tracking-tight text-white no-underline transition-transform hover:scale-105"
            ...
            >
              ...
              {q.length > 0 && (
                <button
                  ...
                  className="rounded-full p-1 text-white/50 hover:text-white hover:bg-white/10 transition-colors flex-shrink-0"
              ...
              >
                  ...
                  {dropdownItems.length > 0 ? (
                    dropdownItems.map((item) => (
                      <Link
                        ...
                        className="group block border-b border-white/5 px-4 py-3 transition-colors hover:bg-white/5 last:border-b-0"
                      >
                        <div className="flex items-start gap-3">
                          <div className="min-w-0 flex-1">
                            <h4 className="text-sm font-semibold text-white group-hover:text-[#ccff00] transition-colors line-clamp-1">
                ...
                {q.length >= 2 && (
                  <button
                    ...
                    className="w-full flex items-center justify-between px-4 py-3 text-sm font-semibold text-[#ccff00] hover:bg-[#ccff00]/5 transition-colors border-t border-white/10 bg-white/[0.02]"
                  >
          ...
          <div className="flex items-center gap-2 md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg p-2.5 text-white transition-colors hover:bg-white/10 border border-white/10"
              aria-label="Search"
            >
            ...
            <button
              ...
              className="inline-flex items-center rounded-lg p-2.5 text-white transition-colors hover:bg-white/10 border border-white/10"
