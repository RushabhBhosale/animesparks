            ...
            <div className="relative w-full md:w-auto p-4 sm:p-6 border-2 border-white/20 bg-black/50 backdrop-blur-sm transform md:-rotate-2 md:hover:rotate-0 transition-transform duration-300">
              ...
              <div className="-mx-1 flex gap-2 overflow-x-auto py-1 px-1 md:flex-wrap md:overflow-visible md:py-0 md:px-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                <Link
                  prefetch={false}
                  href="/categories"
                  className="shrink-0 px-3 py-1 bg-white text-black font-black uppercase text-xs hover:bg-[#f20d0d] hover:text-white skew-x-12 transition-colors"
                >
                  All
                </Link>
        ...
        <div className="max-w-[1600px] mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 auto-rows-min">
                ...
                <div className="relative h-full bg-black border-2 border-[#f20d0d] z-10 overflow-hidden transition-transform duration-500 group-hover:-translate-y-1 group-hover:-translate-x-1">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-6 sm:p-8 md:p-12">
                    <div className="overflow-hidden mb-2">
                      <span className="block text-[#ccff00] font-mono text-[10px] sm:text-xs uppercase tracking-widest transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                        Category /// {formatCount(c0.postCount)}
                      </span>
                    </div>

                    <h2 className="text-4xl sm:text-6xl md:text-8xl font-black uppercase italic tracking-tighter text-white group-hover:text-[#f20d0d] transition-colors leading-[0.9] sm:leading-[0.85]">
                      {c0.title}
                    </h2>
            ...
            {c1 ? (
              ...
              >
                <div className="absolute -inset-1 bg-gradient-to-br from-yellow-400 to-black rounded-sm blur opacity-25 group-hover:opacity-75 transition duration-700 group-hover:duration-200" />
                <div className="relative min-h-[260px] sm:min-h-[300px] md:min-h-[500px] bg-[#1a1a1a] border-2 border-yellow-400 p-1 flex flex-col">
                  ...
                  <div className="h-[52%] sm:h-1/2 p-5 sm:p-6 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <h2 className="text-3xl sm:text-5xl font-black uppercase text-white mb-2 group-hover:text-yellow-400 transition-colors">
                        {c1.title}
                      </h2>
                    ...
                    <div className="flex justify-end relative z-10">
                      <span className="text-3xl sm:text-4xl text-yellow-400 group-hover:rotate-45 transition-transform">
                        ↗
                      </span>
                    </div>
                  </div>
            ...
            {c2 ? (
              ...
              >
                <div className="h-full bg-[#121212] border border-gray-800 hover:border-[#00f3ff] transition-colors p-5 sm:p-6 flex flex-col relative overflow-hidden">
            ...
            {c3 ? (
              ...
              >
                <div className="relative h-full w-full bg-[#f0f0f0] text-black p-1 transform md:rotate-1 group-hover:rotate-0 transition-transform duration-300 shadow-[6px_6px_0px_0px_rgba(242,13,13,1)] md:shadow-[8px_8px_0px_0px_rgba(242,13,13,1)]">
                  <div className="h-full border-2 border-black p-5 sm:p-6 md:p-8 flex flex-col md:flex-row items-stretch md:items-center gap-6 sm:gap-8 relative overflow-hidden">
                    ...
                    <div className="relative w-full md:w-1/2 h-40 sm:h-48 md:h-full">
                      ...
                      <div className="absolute -top-3 -left-3 bg-white border-2 border-black p-3 rounded-tl-xl rounded-br-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transform -rotate-6 z-20 group-hover:scale-110 transition-transform max-w-[85%]">
            ...
            <div className="md:col-span-12 mt-6 sm:mt-8">
              <div className="relative bg-[#050505] border-y-4 border-gray-800 py-10 sm:py-12 group cursor-pointer overflow-hidden">
                <div className="max-w-4xl mx-auto relative z-10 text-center px-2">
                  <h2 className="text-5xl sm:text-7xl md:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#ccff00] via-white to-[#00f3ff] uppercase tracking-tighter mix-blend-difference group-hover:tracking-wide transition-all duration-500">
                    Fandom
                  </h2>
                      ...
                      {fandomChips.length ? (
                        fandomChips.map((cat) => (
                          <Link
                            ...
                            key={cat._id}
                            href={`/categories/${cat.slug}`}
                            className="shrink-0 bg-black border border-white px-4 py-2 rounded-full text-xs font-bold uppercase hover:bg-white hover:text-black transition-colors"
                          >
                            {cat.title}
                          </Link>
                        ))
                ...
                <div className="absolute top-4 left-4 sm:left-10 md:left-32 rotate-12 group-hover:rotate-45 transition-transform duration-500">
                ...
                <div className="absolute bottom-4 right-4 sm:right-10 md:right-32 -rotate-12 group-hover:-rotate-45 transition-transform duration-500">
            ...
            {musicCat ? (
              ...
              >
                <div className="aspect-square bg-gray-900 border border-gray-700 hover:border-white transition-colors relative overflow-hidden flex items-center justify-center">
                  <span className="text-7xl sm:text-8xl text-gray-800 group-hover:text-white transition-colors duration-500 absolute scale-150">
                    ♪
                  </span>
            ...
            {retroCat ? (
              ...
              >
                <div className="h-full min-h-[220px] sm:min-h-[250px] bg-[#f20d0d] relative overflow-hidden flex items-center p-6 sm:p-8 shadow-[8px_8px_0_0_#fff] hover:shadow-[4px_4px_0_0_#fff] hover:translate-x-1 hover:translate-y-1 transition-all">
          ...
          <div className="text-center mt-16 sm:mt-24 opacity-60 hover:opacity-100 transition-opacity">
